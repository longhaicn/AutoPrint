...
public class ManagerFrame extends BaseFrame {
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if ("请输入MAC地址/时间(19991231)".equals(txtSearch.getText())) {
					...
					dtmTable.setDataVector(getTableRowsByCondition(cbxSort.getSelectedIndex(), txtSearch.getText()),
							getTableColumn());
					table.setModel(dtmTable);
				}
	...
	private Vector<Vector<Object>> getTableRowsByCondition(int queryType, String condition) {
		temp = MacManageImpl.queryMacInfoByCondition(queryType, condition);
		return temp;
	}
}
