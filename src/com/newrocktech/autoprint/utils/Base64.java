...
/**
 * A Base64 en/decoder. You can use it to encode and decode strings and byte
 * arrays.
 *
 * @author Tim Roes
 */
public class Base64 {
	...
	private static final char[] code = ("=ABCDEFGHIJKLMNOPQRSTUVWXYZ" + "abcdefghijklmnopqrstuvwxyz0123456789+/")
			.toCharArray();
	 ...
	 *
	 * @param in
	 *            A string representing a base64 encoding.
	 ...
	 * appended to pad the string to a multiple of four are set to -1 in the
	 * array.
	 *
	 * @param in
	 *            A string to encode.
	...
	/**
	 * Encode a byte array and return the encoded byte array. Bytes that has
	 * been appended to pad the string to a multiple of four are set to -1 in
	 * the array.
	 *
	 * @param inArray
	 *            A string to encode.
	...
	public static byte[] encodeAsBytes(byte[] inArray) {
		...
		// Create padded input array with the next largest length that is a
		// multiple of 3
